...
id_reserva int,
fecha_pago date,
método_pago varchar(15),
monto decimal(10,2),
validación_pago varchar(10),
...
insert into pasajeros(nombre_apellido, pasaporte, nacionalidad, teléfono)
values
('Ana García López', 'AB123456', 'Española', '+34123456789'),
...
insert into pagos(id_reserva, fecha_pago, método_pago, monto, validación_pago)
values
